...
\TT{network}. We chose these specific applications to be representative of each
...
\TT{Encryption Core} before being processed by the off-chip DRAM based memory
...
\TT{rijindael} and \TT{ispell}, and the given cache configuration : 32KB size,
...
organized such that each application has two version: \TT{small-input} and
\TT{large-input}. We noticed that for majority of applications, the small and
