...
traces. We focused on using \TT{DRAMSim} \cite{dram-sim} however ran into many
...
\TT{nan}. In addition, the memory trace that DRAMSim used needed timing
...
by each operation and decided instead to write our own \TT{Python} based
analysis script.
