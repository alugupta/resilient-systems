...
with the \TT{PIN} architectural simulator we used. We chose not to use the
\TT{SPEC2006} benchmark as the applications targeted workloads handled
...
a computer architectural simulator. Traditional simulators such as \TT{Gem5}
\cite{gem5} and \TT{ESESC} \cite{esesc} did not meet our constraints. Gem5 and
