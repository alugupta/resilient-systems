...
def main():
    ...
    loadac  = (0.271126760563 , 0.336305213613  , 0.341455044612  , 0.338863636364  , 0.5)
    storeac = (0.00146484375 , 0.0593011811024 , 0.0939597315436 , 0.0737781954887 , 0.5)
    loaddc  = (0.184419014085 , 0.228095582911  , 0.231018359643  , 0.229159090909  , 0.5)
    storedc = (0.00146484375 , 0.0509350393701 , 0.0734060402685 , 0.062734962406  , 0.5)
    print loadac[0]
    ...
    ax.set_xticklabels(('basicmath', 'bitcount', 'jpeg', 'djikstra', 'encrypted'))
